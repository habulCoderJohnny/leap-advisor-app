        ...
        <div className='mt-10'>
            ...
            <div data-aos="zoom-in-up" data-aos-delay="300" className='grid grid-cols-1 lg:grid-cols-3 my-6'>
                ...
                <div>
                    ...
                    <h1 className="lg:text-3xl font-bold py-5">Business Planning</h1>
                ...
                <div>
                    ...
                    <h1 className="lg:text-3xl font-bold py-5">Financial Planning</h1>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
                ...
                <div>
                    ...
                    <h1 className="lg:text-3xl font-bold py-5">Branding Strategy</h1>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
